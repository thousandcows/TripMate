...
<body>
	...
	<div class="container">
		<div class="root">
			...
			<div>></div>
			<div class="community">
				<a href="/companyboard/list?cpage=1">커뮤니티</a>
			</div>
			<div>></div>
			<div class="partyboard">
				<a href="/companyboard/list?cpage=1">동행게시판</a>
			</div>
		</div>
		...
		<form action="/companyboard/modify" method="post" id="frmDetail">
			<div class="board">
				...
				<!-- 글 번호에 맞춰 불러오기 위한 꼼수 -->
				<div class="title">
					<span style="width: 80%;"> <input type=text id=title
						name=title readonly value="${dto.title }"
				...
				<div class="button">
					<button type=button id=back class="btn btn-primary btn-sm"
						style="border: none; background-color: rgb(56, 181, 174);">

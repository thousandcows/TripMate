...
public class ComReplyReplyDTO {
	...
	public ComReplyReplyDTO() {
		super();
	}

	public ComReplyReplyDTO(int seq, int par_seq, int mem_seq, String contents, Date writen_date, String nick) {
		super();
		this.seq = seq;

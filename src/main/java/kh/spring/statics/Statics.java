...
public class Statics {
	public static int areaViewNo = 12;
	public static int areaReviewNo = 5;
	public static int areaRecommandNo = 4;
	...
	public static String FIND_PW_CALLER_PW = "xmflqapdlxm123";
